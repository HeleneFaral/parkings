...
public class ParkingService {
     ...
     * @return String - a correct parking name
     */
    private Color getUserChoiceColor() {
    ...
    public void checkNumberVehicleByColor(final Parking parking) {
        ...
        final int totalVehicle = findVehiculeByColor(parking.getCars(), userChoiceColor) + findVehiculeByColor(parking.getBikes(), userChoiceColor) + findVehiculeByColor(parking.getMotos(), userChoiceColor);
     ...
     */
    private int findVehiculeByColor(final List<Vehicle> vehicles, final Color color) {
     ...
     */
    private Color findColorByValue(final String userColor) {
     ...
     * @return Color - matching color
     */
    private void sendAccessInformations(final Parking parking, final Vehicle vehicle, final TypeVehicle type, final boolean isAllowed, final int emptyPlaces) {
        if (isAllowed) {
     ...
     */
    private boolean isStringNumeric(final String userEntry) {
